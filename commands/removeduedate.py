...
async def removeduedate(ctx, client):
    ...
    if error_check == 1:
        await ctx.channel.send(
            embed = _embedMessage.create("AddDueDate Reply", "The syntax is invalid! Make sure it is in the format $removeduedate course type title stream YYYY MM DD HH:MM"
